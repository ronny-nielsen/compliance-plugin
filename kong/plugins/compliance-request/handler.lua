...
function ComplianceRequest:init_worker()
    -- Implement logic for the init_worker phase here (http/stream)
    kong.log("init_worker")
end

function ComplianceRequest:preread()
    -- Implement logic for the preread phase here (stream)
    kong.log("preread")
end

function ComplianceRequest:certificate(config)
    -- Implement logic for the certificate phase here (http/stream)
    kong.log("certificate")
end

function ComplianceRequest:rewrite(config)
    -- Implement logic for the rewrite phase here (http)
    kong.log("rewrite")
end

function ComplianceRequest:access(config)
    -- Implement logic for the access phase here (http)
    kong.log("access")
    generateToken(config)
    sendRequest(config)
end
function ComplianceRequest:ws_handshake(config)
  -- Implement logic for the WebSocket handshake here
  kong.log("ws_handshake")
end

function ComplianceRequest:header_filter(config)
